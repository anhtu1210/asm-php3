...
<!-- Mirrored from gramentheme.com/html/addina/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 15:46:09 GMT -->
<head>
   <meta charset="utf-8">
   ...
   <link rel="shortcut icon" type="image/x-icon" href="{{ asset('theme/client/assets/imgs/furniture/favicon.png') }}">
   ...
   <link rel="stylesheet" href="{{ asset('theme/client/assets/css/swiper.min.css') }}">
   ...
   <link rel="stylesheet" href="{{ asset('theme/client/assets/css/fontawesome-pro.css') }}">
            ...
            <div class="offcanvas__content">
               <div class="offcanvas__top mb-40 d-flex justify-content-between align-items-center">
                  <div class="offcanvas__logo">
                     <a href="index.html">
                        <img src="{{ asset('theme/client/assets/imgs/furniture/logo/logo-light.svg') }}" alt="logo not found">
                     </a>
                  </div>
                                    ...
                                    <nav>
                                       <div class="nav nav-tabs flex-nowrap flex-sm-column" id="nav-tab" role="tablist">
                                          ...
                                          <button class="nav-link" id="img-2-tab" data-bs-toggle="tab"
                                             ...
                                             aria-selected="false">
                                             <img src="{{ asset('theme/client/assets/imgs/product/details/details-05.png') }}"
                                                alt="product-sm-thumb">
                                          </button>
                                          <button class="nav-link" id="img-3-tab" data-bs-toggle="tab"
                                             data-bs-target="#img-3" type="button" role="tab" aria-controls="img-3"
                                             aria-selected="false">
                                             <img src="{{ asset('theme/client/assets/imgs/product/details/details-06.png') }}"
                                                alt="product-sm-thumb">
                                          </button>
                                       </div>
                                    </nav>
                                    ...
                                    <div class="tab-content" id="productthumbcontent">
                                       <div class="tab-pane fade show active" id="img-1" role="tabpanel"
                                          ...
                                          <div class="product__details-thumb-big w-img">
                                             <img src="{{ asset('theme/client/assets/imgs/product/details/details-04.png') }}" alt="">
                                          </div>
                                       </div>
