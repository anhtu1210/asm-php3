                            ...
                            <div class="your-order">
                                    ...
                                    <table>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <input  type="hidden" name="total_price" value="{{$orderMoney}}">
                                                <td><strong><span
                                ...
                                <div class="payment-method">
                                    <div class="">
                                        ...
                                        <input checked type="radio" value="Cod" name="payment_type" id="cod">
                                        <label for="vnpay">Vn pay</label>
                                        <input type="radio" value="Vn pay" name="payment_type" id="vnpay">

                                    </div>
                                    <div class="order-button-payment mt-20">

                                        <button name="" class="fill-btn" type="submit">
