                                            ...
                                            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                                <div class="product-item">
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <h4 class="product-title"><a href="{{route('product.detail',$item->slug)}}">{{$item->name}}</a>
                                                        </h4>
                                                        <div class="product-price">
                                                            <span class="product-old-price"><del>{{$item->price_regular}}</del></span>
                                                            <span class="product-new-price">{{$item->price_sale}}VND</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-5">
                                            ...
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product1.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <h4 class="product-title"><a href="product-details.html">Alexander
                                                            sofa</a>
                                                    </h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product2.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <h4 class="product-title"><a href="product-details.html">Chair
                                                            pillow</a>
                                                    </h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product3.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <h4 class="product-title"><a href="product-details.html">Curaskin
                                                            Lipgel</a>
                                                    </h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product4.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
                                                ...
                                                <div class="product-content">
                                                    ...
                                                    <h4 class="product-title"><a href="product-details.html">leather
                                                            chair</a>
                                                    </h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product5.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product6.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product7.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <div class="product-thumb">
                                                    <a href="product-details.html"><img
                                                            src="{{ asset('theme/client/assets/imgs/product/product8.png') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="product-action-item">
                                                    <button type="button" class="product-action-btn">
